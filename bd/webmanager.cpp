...
void WebManager::getFoods() {
    QNetworkRequest request( QUrl("http://172.16.161.107:8080/get_foods") );
    manager->get(request);
}

void WebManager::getUsers() {
    QNetworkRequest request( QUrl("http://172.16.161.107:8080/get_users") );
    manager->get(request);
}

void WebManager::post(QString url) {
    QNetworkRequest request( QUrl( QString("http://172.16.161.107:8080/" + url) ) );
    manager->get(request);
}
